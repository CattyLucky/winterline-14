...
";
    ...
    public async Task FailAndStartTest()
    {
        ...
        Assert.That(server.CfgMan.GetCVar(CCVars.GameLobbyDefaultPreset), Is.EqualTo("WLSettlement")); // /// WL Change
        ...
        server.CfgMan.SetCVar(CCVars.GameLobbyDefaultPreset, "WLSettlement"); // /// WL Change
