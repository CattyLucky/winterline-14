...
namespace Content.Shared.Preferences
{
    ...
    {
        public static readonly ProtoId<SpeciesPrototype> DefaultSpecies = "HumanWL"; // /// WL Change
        private static readonly Regex RestrictedNameRegex = new(@"[^A-Za-z0-9\u0400-\u04FF '\-]"); /// WL Change
